...
def getParameters():
    ...
    # general settings
    parser.add_argument('-v', '--version', type=str, default='test1',
    ...
    parser.add_argument('-e', '--ckpt', type=int, default=74,   # default=74
                                help="checkpoint epoch for test phase or finetune phase")

    # training
    parser.add_argument('--experiment_description', type=str,
                                default="traing MSIFNet")

    parser.add_argument('--train_yaml', type=str, default="train_MSIFNet_X4_DIV2K.yaml")
    # system logger
