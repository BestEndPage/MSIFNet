...
def getParameters():
    ...
    # general settings
    parser.add_argument('-v', '--version', type=str, default='MSIFNet_pre',
                                            help="version name for train, test, finetune")

    parser.add_argument('-c', '--cuda', type=int, default=0)
    parser.add_argument('-s', '--checkpoint_epoch', type=int, default=555,
    ...
    parser.add_argument('--test_dataset_name', type=str, default='Manga109',
                choices=['DIV2K', 'B100', 'Urban100', 'Set5', 'Set14', "Manga109"])
    parser.add_argument('--model_path', type=str, default='./train_logs/MSIFNet_pre/checkpoints/MSIFNet.pth')
